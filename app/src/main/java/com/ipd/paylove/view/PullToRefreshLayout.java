...
public class PullToRefreshLayout extends RelativeLayout {
    ...
    public static boolean canPullDown = true;
    public static boolean canPullUp = true;
    public static boolean canPull = true;
    private Context mContext;
    private HKDialogLoading2 dialogLoading;
    ...
    private void initView(Context context) {
        ...
        refreshingAnimation = (Animation) AnimationUtils.loadAnimation(
                context, R.anim.rotate_repeat);
        // 添加匀速转动动画
        LinearInterpolator lir = new LinearInterpolator();
        Animation.setInterpolator(lir);
        refreshingAnimation.setInterpolator(lir);
        dialogLoading=new HKDialogLoading2(context,R.style.HKDialog);
    ...
    private void changeState(int to) {
        ...
        switch (state) {
            ...
            case RELEASE_TO_REFRESH:
                ...
                pullView.startAnimation(Animation);
                break;
            case REFRESHING:
                // 正在刷新状态
                pullView.clearAnimation();
            ...
            case RELEASE_TO_LOAD:
                ...
                pullUpView.startAnimation(Animation);
                break;
            case LOADING:
                // 正在加载状态
                pullUpView.clearAnimation();
