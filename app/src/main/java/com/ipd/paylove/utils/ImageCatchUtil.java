...
/**
 * Created by qiuyawei on 2016/12/7.
 */
public class ImageCatchUtil {
     ...
     * 清除图片所有缓存
     */
    public void clearImageAllCache(String ImageExternalCatchDir) {
        clearImageDiskCache();
     ...
     * @return CacheSize
     */
    public String getCacheSize(File ImageExternalCatchDir) {
        try {
            return getFormatSize(getFolderSize(ImageExternalCatchDir));
        } catch (Exception e) {
            e.printStackTrace();
        }
        return "";
